...
public class DashboardAuthControllerTest {
    ...
    public void authCorrectUserCredentialShouldReturnSuccess() throws Exception {
        var loginCredential = new AuthRequestDto("test2@gmail.com", "12345678");
    ...
    public void authWithWrongCredentialShouldReturnUnauthorized() throws Exception {
        var loginCredential = new AuthRequestDto("nouser@gmail.com", "123456");
        var content = objectMapper.writeValueAsString(loginCredential);
        mockMvc.perform(post(url)
                .contentType(MediaType.APPLICATION_JSON)
                .content(content))
